...
{
    /// <summary>Personal resource UI; displays only confirmed Host resource values and recovery.</summary>
    [DisallowMultipleComponent]
    [RequireComponent(typeof(SplitScreenLayout))]
    public sealed class T07Hud : MonoBehaviour
    {
        ...
        private bool canEnd;
        private bool canGenerate, canDebugFixture, canDebugCombined;
        ...
        public Button DebugCombinedButton { get; private set; }
        ...
        public void SetControls(bool host, bool join, bool reset, bool end, bool generate,
            bool debugFixture, bool debugCombined)
        {
            canHost = host; canJoin = join; canReset = reset; canEnd = end;
            canGenerate = generate; canDebugFixture = debugFixture; canDebugCombined = debugCombined;
            ...
            if (DebugCombinedButton != null) DebugCombinedButton.interactable = canDebugCombined;
            RefreshDebugVisibility();
        }

        private void RefreshDebugVisibility()
        {
            if (DebugCombinedButton != null) DebugCombinedButton.gameObject.SetActive(debugMode);
        }
        ...
        private void Awake()
        {
            ...
            SetControls(canHost, canJoin, canReset, canEnd, canGenerate, canDebugFixture, canDebugCombined);
        ...
        {
            var canvasRect = Rect("T07Overlay", transform);
            ...
            {
                var events = new GameObject("T07EventSystem", typeof(EventSystem), typeof(InputSystemUIInputModule));
        ...
        private void CreateUpperHud()
        {
            ...
            var preview = Text("PreviewCaption", header, "T07  /  PERSONAL RESOURCES", 10, Muted, TextAnchor.LowerLeft);
        ...
        private void CreateLowerHud()
        {
            ...
            GenerateButton = CreateButton("GenerateButton", resourceButtons, "GENERATE  /  20", 0f, .52f);
            ...
            DebugCombinedButton = CreateButton("DebugCombinedButton", resourceButtons, "DEV\nHIT ORB", .76f, 1f);
            DebugCombinedButton.gameObject.SetActive(false);
